...
const TIERS = [
  { name: "Micro",       badge: "T0", ram: "< 1 GB avail",   ramGb: 0.9,  color: "text-blue-400",   borderColor: "border-blue-400/40",   bg: "bg-blue-400/5",   device: "Old Android phones, tiny SBCs",        models: ["SmolLM2 135M", "Qwen3 0.6B", "TinyLlama", "Gemma 3 1B"],                        backend: "llama.cpp (CPU)" },
  { name: "Low",         badge: "T1", ram: "1–3 GB avail",   ramGb: 2.9,  color: "text-cyan-400",    borderColor: "border-cyan-400/40",    bg: "bg-cyan-400/5",   device: "Budget phones, Raspberry Pi 4",        models: ["Llama 3.2 1B", "DeepSeek R1 1.5B", "SmolLM2 1.7B", "Phi-4 Mini"],                  backend: "llama.cpp / Vulkan (mobile GPU)" },
  { name: "Low-Mid",     badge: "T2", ram: "3–6 GB avail",   ramGb: 5.9,  color: "text-teal-400",    borderColor: "border-teal-400/40",    bg: "bg-teal-400/5",   device: "Mid-range phones, old laptops, Pi 5",  models: ["Mistral 7B", "Llama 3.1 8B", "DeepSeek R1 7B", "Llama 3.2 3B"],                  backend: "llama.cpp / Vulkan / Ollama" },
  { name: "Mid",         badge: "T3", ram: "6–12 GB avail",  ramGb: 11.9, color: "text-primary",     borderColor: "border-primary/40",     bg: "bg-primary/5",    device: "Gaming PCs, modern laptops",           models: ["Gemma 3 12B", "Qwen3 8B", "DeepSeek R1 8B", "Mistral NeMo 12B"],                      backend: "CUDA / ROCm / Metal / Ollama" },
          ...
          {specs.ramSupported && tier ? (
            <div className={`border p-5 sm:p-6 ${tier.borderColor} ${tier.bg}`}>
              ...
              <div className="mt-5 pt-4 border-t border-border/40">
                <a href="https://github.com/DeVenLucaz/llamdrop" target="_blank" rel="noopener noreferrer"
...
const BROWSE_MODELS = [
  ...
  { icon: "●", name: "Qwen3 0.6B",               type: "fast/chat",      quant: "Q4_K_M", size: "0.40GB", ram: "1.0GB",  fit: "Great",   fc: "text-green-400",  dl: false, bench: "" },
  { icon: "●", name: "SmolLM2 1.7B",             type: "chat/coding",    quant: "Q4_K_M", size: "1.00GB", ram: "2.0GB",  fit: "Good",    fc: "text-cyan-400",   dl: false, bench: "" },
  ...
  { icon: "●", name: "Llama 3.2 1B",             type: "chat/general",   quant: "Q4_K_M", size: "0.80GB", ram: "1.8GB",  fit: "Good",    fc: "text-cyan-400",   dl: false, bench: "" },
  { icon: "●", name: "DeepSeek R1 1.5B",         type: "reasoning",      quant: "Q4_K_M", size: "1.10GB", ram: "2.0GB",  fit: "Good",    fc: "text-cyan-400",   dl: false, bench: "" },
  { icon: "○", name: "Phi-4 Mini 3.8B",          type: "reasoning",      quant: "IQ2_M",  size: "1.20GB", ram: "2.0GB",  fit: "Good",    fc: "text-cyan-400",   dl: false, bench: "" },
  { icon: "○", name: "Llama 3.2 3B",             type: "chat/reasoning", quant: "Q2_K",   size: "1.00GB", ram: "2.2GB",  fit: "Tight",   fc: "text-yellow-400", dl: false, bench: "" },
...
function CliDemo() {
  ...
  const MENU_ITEMS: { id: ScreenId; sym: string; label: string; desc: string; highlight?: boolean }[] = [
    ...
    { id: 'doctor',      sym: '🩺', label: 'Doctor',               desc: 'Auto-Healing: Repairs broken configs or corrupted binaries with a single keystroke' },
  ...
  const SubHdr = () => (
    <div className="px-3 py-1.5 border-b border-border/20 bg-black/60 font-mono text-[10px] leading-[1.55] flex-shrink-0">
      ...
      <div className="text-muted-foreground/50">v0.10.0 - Free forever - GPL v3 - github.com/DeVenLucaz/llamdrop<br />rop</div>
      ...
      case 'doctor': return (
        <div className="font-mono text-[9px] sm:text-[10px] space-y-1.5">
          {[
            ...
            { label: "Model catalog", items: ["✓ models.json valid — v0.10.0, 30 models, updated 2026-06-20"] },
      ...
      case 'update': return (
        <div className="font-mono text-[10px] sm:text-xs space-y-1.5">
          ...
          <div className="mt-1 space-y-0.5">
            ...
            <div className="text-muted-foreground/70">Installed : <span className="text-foreground">v0.10.0</span></div>
            <div className="text-muted-foreground/70">Available : <span className="text-foreground">v0.10.0</span></div>
          </div>
    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-primary selection:text-primary-foreground font-sans">
      ...
      <nav className="fixed top-0 w-full border-b border-border/40 bg-background/85 backdrop-blur-md z-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between">
          ...
          <a
            href="https://github.com/DeVenLucaz/llamdrop"
            target="_blank"
          ...
          >
            ...
            GitHub
				...
				<a href="activity" className="flex items-center gap-2 text-sm font-mono border border-border px-4 py-2 hover:bg-primary hover:text-primary-foreground hover:border-primary transition-all">Activity</a></div>
      </nav>
      ...
      <section className="pt-24 sm:pt-36 pb-14 sm:pb-24 px-4 sm:px-6 max-w-6xl mx-auto">
        ...
        >
          <div className="flex items-center gap-3 mb-8 flex-wrap">
            ...
            <span className="border border-border text-muted-foreground px-3 py-1 text-xs font-mono uppercase tracking-wider">v0.10.0</span>
          ...
          <div className="flex flex-wrap gap-3 sm:gap-5 mb-10 sm:mb-14 text-xs sm:text-sm font-mono text-muted-foreground">
            {["5 device tiers", "30 verified models", "HuggingFace live search", "Dynamic Backend Probing", "No configuration"].map((s) => (
          ...
          <div className="max-w-4xl border border-border p-4 sm:p-6 bg-card/60 backdrop-blur space-y-5 sm:space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <TerminalBlock label="Linux / Android (Termux) / SBCs" command="curl -sL https://raw.githubusercontent.com/DeVenLucaz/llamdrop/main/install.sh | bash" />
            </div>
      ...
      <FadeIn className="py-14 sm:py-24 px-4 sm:px-6 max-w-6xl mx-auto">
        <div className="mb-10">
          <p className="text-xs font-mono text-primary uppercase tracking-widest mb-3">5 Device Tiers</p>
      ...
      <FadeIn className="py-14 sm:py-24 px-4 sm:px-6 bg-card border-y border-border">
        <div className="max-w-6xl mx-auto">
          <div className="mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-5xl font-bold mb-4">30 verified models.<br />The entire HuggingFace GGUF library.</h2>
            <p className="text-lg text-muted-foreground max-w-2xl">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="border border-primary/40 bg-primary/5 p-5 sm:p-8 relative overflow-hidden">
              ...
              <p className="text-muted-foreground mb-6 leading-relaxed">
                30 models with confirmed performance data from users across platforms — Reddit, Discord, GitHub issues, and community testing. Every entry has validated RAM requirements and proven quantization settings for each tier.
              </p>
              <ul className="space-y-2 font-mono text-sm">
                {[
                  ...
                  "Llama 3, Qwen3, DeepSeek R1, Gemma 3, Phi-4, Mistral, and more",
                ].map((item) => (
      ...
      <FadeIn className="py-20 sm:py-32 px-4 sm:px-6 max-w-4xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            href="https://github.com/DeVenLucaz/llamdrop/blob/main/README.md"
            target="_blank"
            rel="noopener noreferrer"
      ...
      <footer className="py-8 px-6 border-t border-border/40 text-sm text-muted-foreground font-mono">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span>llamdrop v0.10.0 &copy; {new Date().getFullYear()}</span>
          </div>
          <div className="flex items-center gap-4">
            <span>GPL v3 Licensed</span>
            <span className="text-border">|</span>
            <a href="https://github.com/DeVenLucaz/llamdrop" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">GitHub</a>
          </div>
        </div>
      </footer>
    </div>
